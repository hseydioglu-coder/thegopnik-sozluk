    ...
    <div className="min-h-screen bg-[#0d0d0d] text-[#E0E0E0] flex flex-col font-sans antialiased">
      ...
      <main className="flex-grow flex flex-col items-center pt-[8vh] sm:pt-[12vh] px-4 sm:px-8 text-center w-full">
        ...
        <h1 className="text-4xl sm:text-5xl font-black uppercase tracking-tight text-[#C61010] pt-2 drop-shadow-md">
          {lang === "tr" ? (
            <>THE GOPNİ<span className="relative">K<span className="absolute -top-0 -right-4 text-xs sm:text-sm font-black leading-none text-[#ff3333]">+18</span></span></>
          ) : (
            <>THE ГОПНИ<span className="relative">К<span className="absolute -top-0 -right-4 text-xs sm:text-sm font-black leading-none text-[#ff3333]">+18</span></span></>
          )}
        </h1>
